...
const LoginBreeder = () => {
    const {api, breeder, loginBreeder} = useAppContext();
                    ...
                    <React.Fragment>
                        ...
                        <div style={{ width: '100%', flexGrow: 1, overflow: 'hidden' }}>
                            <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                                ...
                                <br></br>
                                <p>No account? <Link to={"/registerBreeder"}>Register Here!</Link></p>
                            </Box>
                        </div>
                    </React.Fragment>
